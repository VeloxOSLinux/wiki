...
sudo pacman -Syu
```
:::tip[Note] If conflicts arise between Manjaro and CachyOS packages, the system will automatically prefer the Manjaro variant unless a package is not present in the Manjaro repositories. :::
...
:::caution[Important] Never manually mix in repositories from other distributions (like direct Arch repos), as this can break the Manjaro base. Stick to the configuration provided by VeloxOS. :::
